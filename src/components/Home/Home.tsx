...
import smash_poster from '../../assets/images/doper_poster.jpg';
...
const useStyles = makeStyles({
    ...
    logo_a: {
        ...
        main: {
            backgroundImage : `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${smash_poster})`,
            width: '100%',
            height: '100%',
    ...
    <div className= {classes.root}>
        ...
        <main className={classes.main}>
            <div className={classes.main_text}>
                <h1> { props.title } </h1>
                <p>I Love Smash!</p>
                <Button color= 'primary' variant ='contained'>Smash This Button</Button>
